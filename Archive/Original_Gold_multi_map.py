# the original scripts CCDC support give me, which could dock 1 MOF with many ligands, (CCDC sopport told me, it is too old) The link of this script: https://downloads.ccdc.cam.ac.uk/GOLD/HPC/gold_multiprocessing.zip. Both Gold_multi_map and Gold_multi_queue are from Gold instruction.
#! /usr/bin/env python
########################################################################################################################
#
