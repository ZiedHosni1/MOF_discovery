# Chatgpt modify could dock many MOFs with 1 amino acid (modify from  Gold_multi_queue)
#! /usr/bin/env python
########################################################################################################################
#
...
if __name__ == '__main__':
    ...
    mof_input_files = "MOF_subset.mol2"
    amino_acid_file = "glycine structure.mol2"
    conf_file = "gold.conf"
